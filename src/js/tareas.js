( function() {
    ...
    const nuevaTareasBtn = document.querySelector('#agregar-tarea');
    nuevaTareasBtn.addEventListener('click', function(){
        mostrarFormulario();
    });
    ...
    function mostrarTareas(){
        ...
        arrayTareas.forEach(tarea => {
            ...
            const btnElimianrTarea = document.createElement('BUTTON');
            btnElimianrTarea.classList.add('eliminar-tarea');
            btnElimianrTarea.dataset.idTarea = tarea.id;
            btnElimianrTarea.textContent = 'Eliminar';
            btnElimianrTarea.ondblclick = function(){
                confirmarEliminarTarea({...tarea});
            }

            opcionesDiv.appendChild(btnEstadoTarea);
            opcionesDiv.appendChild(btnElimianrTarea);
    ...
    async function agregarTarea(tarea){
        ...
        try{
            ...
            if(resultado.tipo === 'exito'){
               ...
               // Agregar el objeto de tarea a lglobal de tareas
               const tareaObj = {
